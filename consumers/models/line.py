...
class Line:
    ...
    def process_message(self, message):
        ...
        topic = message.topic()
        if topic == config['topics.consumers']['faust.station.transformed']:
            try:
        ...
        elif topic.startswith(config['topics.producers']['station.arrival.prefix']):
            self._handle_arrival(message)
        # Set the conditional to the KSQL Turnstile Summary Topic
        elif topic == config['topics.consumers']['turnstile.summary']:
